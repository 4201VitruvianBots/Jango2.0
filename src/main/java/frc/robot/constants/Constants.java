...
public final class Constants {
        ...
        public static final double airResistanceCoefficient = 1.05; // Constant that shoot velocity is multiplied by to
        ...
        public static final double verticalTargetDistance = Units.inchesToMeters(98.25 - 38); // Distance between
                                                                                              // shooter and target
                                                                                              // heights from ground
        public static final double verticalShooterAngle = Math.PI / 3; // Angle ball is shot from shooter relative to
                                                                       // the ground
        ...
        public static final double maxShooterRPM = 3500; // Highest RPM that shooter can launch balls at without
                                                         // breaking
        ...
        public static final class DriveConstants {
                ...
                // // Encoders are not on the wheel shaft for Falcons, so need to multiply by
                // gear ratio
                // (kWheelDiameterMeters * Math.PI) / (double) kFalconEncoderCPR *
                // kDriveGearingLow;
                // public static final double kEncoderDistancePerPulseSim =
                // // Assumes the encoders are directly mounted on the wheel shafts
                // (kWheelDiameterMeters * Math.PI) / (double) kMagEncoderCPR *
                // kDriveGearingHigh;
                ...
                public static final double kaVoltSecondsSquaredPerMeter = 0.034742;
                ...
                public static final double kaVoltSecondsSquaredPerRadian = 0.19;// inSlowGear ? 0.111 : -0.0132; //
                                                                                // originally 0.3
